...
# Development Environment
  ...
  KiCad symbols and footprints created using KiCad 6.0.10 and finalized using [KiCad 7.0.11](https://github.com/KiCad/kicad-source-mirror/releases/tag/7.0.11)
